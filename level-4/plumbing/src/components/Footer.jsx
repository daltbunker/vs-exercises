    ...
    return (
        <footer style={container}>
            ...
            <div style={icons}>
                ...
                <div style={{...iconImage, backgroundImage: "url(https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.freepngimg.com%2Fthumb%2Ffacebook%2F65541-logo-facebook-icon-free-hq-image.png&f=1&nofb=1)", transform: "scale(0.9) translateY(1px)"}}></div>
            </div>
        </footer>
    )
}
