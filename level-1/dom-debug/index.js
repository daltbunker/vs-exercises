...
document.getElementById("add").addEventListener("click", function(){  // Changed from onclick to click and removed 'e' parameter
...
function createSubItem(){ // removed 'e' parameter
